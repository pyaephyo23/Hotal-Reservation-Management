       ...
       01  WS-HEADER-1.
           ...
           05 FILLER               PIC X(3) VALUE SPACES.
           05 FILLER               PIC X(8) VALUE 'CHECK-IN'.
           05 FILLER               PIC X(3) VALUE SPACES.
           05 FILLER               PIC X(9) VALUE 'CHECK-OUT'.
       ...
       01  WS-DETAIL-LINE.
           ...
           05 FILLER               PIC X(3) VALUE SPACES.
           05 WS-DL-CHECKIN        PIC X(8).
           05 FILLER               PIC X(3) VALUE SPACES.
           05 WS-DL-CHECKOUT       PIC X(8).
           05 FILLER               PIC X(2) VALUE SPACES.
       ...
       DISPLAY-BOOKING-RECORD.
           ...
           MOVE CHECKIN-DATE TO WS-DL-CHECKIN
           MOVE CHECKOUT-DATE TO WS-DL-CHECKOUT
